...
# Continuous Control - Reinforcement learning agent

### Introduction

This project trains agent for [Reacher](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#reacher) environment.
...
This project solves two separate versions of the Unity environment:
...
```bash
git clone https://github.com/abhismatrix1/Continous-control.git
...
5. Place the file in the this GitHub repository folder, and unzip (or decompress) the file. 
